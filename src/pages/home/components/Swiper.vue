<template>
  <div class="wrapper" ref="caroucel">
    <swiper v-if="swiperList.length > 1" ref="mySwiper" :options="swiperOptions" >
  ...
  data () {
    return {
      ...
      swiperList: [
          {
              id: 1,
              imgUrl: 'https://imgs.qunarzz.com/vs_ceph_vcimg/8f45c9a4b40091390793e1c4a5ac3e40.jpeg'
          },
          {
              id: 2,
          ...
          {
              id: 3,
              imgUrl: 'https://imgs.qunarzz.com/vs_ceph_vcimg/a59f46c137856a29be67446ab9c0ad5d.jpeg'
          }
      ]
    }
  },
